...
<p>
Assume the data follow a log‑normal distribution. For each question, first describe your reasoning for the analysis, then write code to carry out the analysis. Finally, summarize the results to draw a conclusion.
</P>
...
d). Using the Central Limit Theorem to construct a **95% asymptotic confidence interval** for $mu_{LN} = \mathbb{E}[X]$.

f). Assuming both confidence intervals above are valid, compare them in terms of performance and recommend which method should be used in this analysis. Justify your recommendation.
</p>
