...
**Asymptotic Distribution**: $W \xrightarrow{d} \chi^2_q$ under $H_0$, where $q$ is the numer of parameters in the null hypothesis.

**Assumptions**: Wald test requires only the unconstrained MLE and is sensitive to parameterization.
